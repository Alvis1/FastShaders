...
export default function() {
  const color1 = color(0x9eecff);
  const color2 = color(0x055557);
  ...
  const perlinNoise1 = perlinNoise({ position: uv1, scale: 1.296, balance: 0, contrast: 0, color: color(0xFFFFFF), background: color(0x000000), seed: mul1 });
  const perlinNoise2 = perlinNoise({ position: uv2, scale: 0.2, balance: 0, contrast: 0, color: color(0xFFFFFF), background: color(0x000000), seed: mul2 });
