...
export default function() {
  ...
  const color1 = color(0x0000a0);
  const color2 = color(0x8080ff);
  const mul1 = mul(time1, 4.669);
  const mul2 = mul(time1, -0.258);
  const voronoiCells1 = voronoiCells({ scale: 2, variation: 0, facet: 0, color: color(0x000000), background: color(0xC0D0FF), seed: mul1 });
  ...
  const remap1 = remap(voronoiCells2, 0.5, 1, 0, 1);
