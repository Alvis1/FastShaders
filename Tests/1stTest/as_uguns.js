...
export default function() {
  ...
  const perlinNoise2 = perlinNoise({ position: uv2, scale: 1.1, balance: 0, contrast: 0, color: color(0xFFFFFF), background: color(0x000000), seed: mul2 });
  ...
  return { colorNode: mix1, positionNode: positionLocal.add(normalLocal.mul(mul5)), opacityNode: mul4, transparent: true };
}
