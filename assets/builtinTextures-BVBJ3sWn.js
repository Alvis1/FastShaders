import{b as n}from"./codeGroupBuilder-D_QZcMDB.js";import"./vendor-babel-C8Dynvqr.js";import"./vendor-react-CVkjjuGB.js";import"./tokens-BRj_uTkc.js";import"./preload-DiXeQ6_L.js";import"./vendor-xyflow-CIfuUpQH.js";import"./vendor-dagre-CdVMPvTX.js";const c=`import { add, color, exp, Fn, fract, mix, mul, positionGeometry, smoothstep, sqrt, sub, uniform } from "three/tsl";
...
export default shader;`,e=`import { abs, add, color, Fn, min, mix, mul, positionGeometry, round, smoothstep, sub, uniform } from "three/tsl";
...
export default shader;`,r=`import { add, color, div, exp, Fn, mix, mul, mx_noise_float, oneMinus, positionGeometry, smoothstep, sub, uniform, vec3 } from "three/tsl";
...
export default shader;`,l=`import { add, Fn, mul, mx_noise_float, round, screenUV, sin, time, uniform, vec3 } from "three/tsl";
...
export default shader;`,i=`import { abs, add, clamp, color, div, exp, Fn, mul, mx_noise_float, oneMinus, positionGeometry, pow, sub, uniform, vec3 } from "three/tsl";
...
export default shader;`,a=`import { abs, add, color, div, exp, Fn, mix, mul, mx_noise_float, oneMinus, positionGeometry, pow, smoothstep, sub, uniform, vec3 } from "three/tsl";
...
export default shader;`,u=`import { abs, add, color, Fn, mix, mul, mx_noise_float, oneMinus, positionGeometry, pow, uniform } from "three/tsl";
...
export default shader;`,m=`import { add, color, cos, div, exp, Fn, max, mix, mul, mx_noise_float, positionGeometry, sin, sub, uniform, vec3 } from "three/tsl";
...
export default shader;`,t=[{id:"polka-dots",name:"Polka Dots",color:"#3949AB",code:c,description:"A repeating lattice of soft-edged dots — adjustable scale, size and blur."},{id:"grid",name:"Grid",color:"#546E7A",code:e,titleSize:2,description:"Graph-paper grid of thin dark lines on a light background."},{id:"tiger-fur",name:"Tiger Fur",color:"#F57C00",code:r,description:"Orange fur with noise-broken dark stripes, fading to a pale belly."},{id:"static-noise",name:"Static Noise",color:"#757575",code:l,description:"Fine grayscale noise, like analogue TV static."},{id:"crumpled-fabric",name:"Crumpled Fabric",color:"#26A69A",code:i,description:"Crinkled cloth-like color pattern — domain-warped noise blending pale cyan, indigo and deep green."},{id:"gas-giant",name:"Gas Giant",color:"#AB47BC",code:a,description:"Banded planet atmosphere with turbulent storm swirls, Jupiter-style."},{id:"marble",name:"Marble",color:"#5C6BC0",code:u,description:"Pale stone run through with sharp noise-driven veins."},{id:"wood",name:"Wood",color:"#8D6E63",code:m,titleSize:2,description:"Concentric growth rings warped by noise, in warm timber tones."}];let o=null;function h(){return t.map(s=>s.id)}function _(){return o||(o=t.map(s=>n(s,"builtin-texture-")),o)}export{h as getBuiltinTextureIds,_ as getBuiltinTextures};
